...
#define IQUEUEMAC_CP_DURATION_US        (20000U * 1000)
#endif

#ifndef IQUEUEMAC_SLEEP_DURATION_US
#define IQUEUEMAC_SLEEP_DURATION_US        (40000U * 1000)
#endif

#ifndef IQUEUEMAC_VTDMA_DURATION_US
#define IQUEUEMAC_VTDMA_DURATION_US        (30000U * 1000)
#endif

#ifndef IQUEUEMAC_VTDMA_LONG_DURATION_US
#define IQUEUEMAC_VTDMA_LONG_DURATION_US        (35000U * 1000)
#endif

#ifndef IQUEUEMAC_VTDMA_LONG_LONG_DURATION_US
#define IQUEUEMAC_VTDMA_LONG_LONG_DURATION_US        (37000U * 1000)
#endif
